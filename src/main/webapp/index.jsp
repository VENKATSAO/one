...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">WE ARE SUCCESS bhbhFULLY DEPLOYED APPLICATION</h1>
	<h1 style="color: blue; font-size: 40px;" align="center">WE kkkfkjkhbkhbkrsgbkfsbgkTO JENKINS</h1>
